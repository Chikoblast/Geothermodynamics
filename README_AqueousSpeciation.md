...
> Take aqueous speciation table and place it in "phr_solution()." Be careful with the syntax or else the speciation will not be imported into the PHREEQC calculations. 
